<!doctype html>
<?php $meta = get_page_by_path('strona-glowna/meta');
...
<html lang="pl" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title><?php the_field('site-title', $meta);?>» <?php the_title();?></title>
  <?php wp_head();?>
  </head>
  <body>
    <header class="main-header clearfix">
      <a href="<?php echo get_home_url(); ?>" class="home-url"><img src="<?php the_field('header-logo', $meta);?>" alt="<?php the_field('header-logo-alt', $meta);?>" class="header-logo"></a>
      <nav class="top-navigation">
        <div class="top-navigation-item">
          <a href="tel://<?php the_field('header-phone', $meta);?>"><?php echo $phone_icon ?><?php the_field('header-phone-content', $meta);?></a>
        </div>
        <div class="top-navigation-item">
          <a href="mailto:<?php the_field('header-email', $meta);?>"><?php echo $mail_icon ?><?php the_field('header-email-content', $meta);?></a>
        </div>
        <div class="top-navigation-item">
          <a href="<?php the_field('header-location', $meta);?>"><?php echo $location_icon ?><?php the_field('header-location-content', $meta);?></a>
        </div>
        <div class="top-navigation-item">
          <a href="<?php the_field('header-facebook', $meta);?>"><?php echo $facebook_icon ?></a>
        </div>
        <div class="top-navigation-item">
          <a href="<?php the_field('header-instagram', $meta);?>"><?php echo $instagram_icon ?></a>
        </div>
        <div class="top-navigation-item">
          <a href="#"><?php echo $search_icon ?></a>
        </div>
      </nav>
    </header>
