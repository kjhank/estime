<?php get_header();
  ...
  <section class="page-section">
    ...
    <?php if (have_posts()) : ?>
      ...
      <section class="treatment-description">
        <?php if (get_field('treatment-benefits')): ?>
          <h2>korzyści</h2>
          <p><?php the_field('treatment-benefits');?></p>
        <?php endif; ?>
        <?php if (get_field('treatment-whatis')): ?>
          <h2>na czym polega zabieg?</h2>
          <p><?php the_field('treatment-whatis');?></p>
        <?php endif; ?>
        <?php if (get_field('treatment-details')):?>
          <h2>szczegóły</h2>
          <p><?php the_field('treatment-details');?></p>
        <?php endif; ?>
        <?php if (get_field('treatment-posttreatment')): ?>
          <h2>po zabiegu</h2>
          <p><?php the_field('treatment-posttreatment');?></p>
        <?php endif; ?>
        <section class="indications-contraindications clearfix">
          <div class="indications">
            <?php if (get_field('treatment-indications')): ?>
              <h4>wskazania</h4>
              <?php the_field('treatment-indications');?>
            <?php endif; ?>
          </div>
          <div class="contraindications">
            <?php if(get_field('treatment-contraindications')): ?>
              <h4>przeciwwskazania</h4>
              <?php the_field('treatment-contraindications');?>
            <?php endif; ?>
          </div>
        </section>
        <?php
          if( have_rows('treatment-misc') ):?>
          <?php
            while ( have_rows('treatment-misc') ) : the_row();?>
            <h2><?php the_sub_field('misc-heading');?></h2>
            <p><?php the_sub_field('misc-description');?></p>
              <?php
            endwhile;
            ?>
          <?php
        ...
        ?>
        <nav class="treatment-nav clearfix">
          <a href="<?php the_field('signup-url');?>"><?php the_field('signup-url-text');?></a>
          <a href="<?php the_field('pricing-url');?>"><?php the_field('pricing-url-text');?></a>
        </nav>
      </section>
