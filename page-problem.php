<?php get_header();
  /* Template name: strony 'twój problem' */
  ...
  <section class="page-section">
    ...
    <?php if (have_posts()) : ?>
      ...
      <?php the_content();// Individual Post Styling ?>
        <?php
          if( have_rows('treatment-repeater') ):?>
          <section class="treatments">
            <h2>zabiegi</h2>
          <?php
            while ( have_rows('treatment-repeater') ) : the_row();?>
              <a class="single-treatment clearfix" href="<?php the_sub_field('treatment-url');?>" style="background-image: url(<?php the_sub_field('treatment-photo');?>)">
                  <div class="treatment-name">
                    <?php the_sub_field('treatment-name');?>
                  </div>
                  <?php //the_sub_field('team-member-position');?>
                <!-- <img src="" alt="<?php the_sub_field('treatment-photo-alt');?>" class="treatment-photo"> -->
              </a>
